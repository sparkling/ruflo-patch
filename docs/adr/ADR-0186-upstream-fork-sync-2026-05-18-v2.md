...
status: accepted
date: 2026-05-18
tags: [upstream-sync, fork-management, runbook]
supersedes: []
depends-on: [ADR-0117, ADR-0143, ADR-0161, ADR-0167, ADR-0177, ADR-0180, ADR-0181, ADR-0184, ADR-0185]
implements: []
---

# Upstream fork sync — May 18, 2026 (v2, takes over ADR-0162's unlanded work)

> **Document type**: upstream-sync runbook (AI executor), v2 of ADR-0162's unlanded work. Original frontmatter recorded `methodology: [SPARC, MADR, runbook]`, `decision-makers: [Henrik Pettersen]`, `audience: ai-executor`, `state_schema: 2`, `related: [0094, 0143, 0156, 0162, 0167, 0177, 0180]`, status accepted/implemented/completed 2026-05-18.

## Preflight corrections (recorded during authoring)
...
* This runbook takes over the unlanded portion of ADR-0162 (kept open; v1
  amendment records partial close-out for Batches A/B/C+D/E/F/K).
