...
check_adr0142_bin_path() {
  ...
  # Use shared wrapper-solo install built in BACKGROUND at harness boot
  # (scripts/test-acceptance.sh, joined before parallel wave). Eliminates
  # the per-check 82-93s npm install. Falls back to per-check install if
