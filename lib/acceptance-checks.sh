...
source "${_CHECKS_DIR}/acceptance-adr0113-plugin-checks.sh"

# ADR-0094: 100% acceptance coverage (Phase 1-7)
source "${_CHECKS_DIR}/acceptance-aidefence-checks.sh"
source "${_CHECKS_DIR}/acceptance-claims-checks.sh"
source "${_CHECKS_DIR}/acceptance-agent-lifecycle-checks.sh"
source "${_CHECKS_DIR}/acceptance-autopilot-checks.sh"
source "${_CHECKS_DIR}/acceptance-workflow-checks.sh"
source "${_CHECKS_DIR}/acceptance-guidance-checks.sh"
source "${_CHECKS_DIR}/acceptance-hivemind-checks.sh"
source "${_CHECKS_DIR}/acceptance-coordination-checks.sh"
source "${_CHECKS_DIR}/acceptance-daa-checks.sh"
source "${_CHECKS_DIR}/acceptance-session-lifecycle-checks.sh"
source "${_CHECKS_DIR}/acceptance-task-lifecycle-checks.sh"
source "${_CHECKS_DIR}/acceptance-browser-checks.sh"
source "${_CHECKS_DIR}/acceptance-terminal-checks.sh"
source "${_CHECKS_DIR}/acceptance-embeddings-checks.sh"
source "${_CHECKS_DIR}/acceptance-transfer-checks.sh"
source "${_CHECKS_DIR}/acceptance-github-integration-checks.sh"
source "${_CHECKS_DIR}/acceptance-wasm-checks.sh"
source "${_CHECKS_DIR}/acceptance-neural-checks.sh"
source "${_CHECKS_DIR}/acceptance-ruvllm-checks.sh"
source "${_CHECKS_DIR}/acceptance-performance-adv-checks.sh"
source "${_CHECKS_DIR}/acceptance-progress-checks.sh"
source "${_CHECKS_DIR}/acceptance-hooks-lifecycle-checks.sh"
source "${_CHECKS_DIR}/acceptance-error-paths-checks.sh"
source "${_CHECKS_DIR}/acceptance-input-validation-checks.sh"
