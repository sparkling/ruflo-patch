...
# ════════════════════════════════════════════════════════════════════
# Shared helper: _aidefence_invoke_tool
# ════════════════════════════════════════════════════════════════════
#
# Arguments (positional):
#   $1 tool             — MCP tool name (e.g. "aidefence_scan")
#   $2 params           — JSON params string (e.g. '{"input":"hello"}')
...
_aidefence_invoke_tool() {
  ...
  local work; work=$(mktemp /tmp/aidefence-${tool}-XXXXX)
