...
// that do real `npm install` + CLI subprocess fan-out. Override via
// TEST_TIMEOUT env var. Fast iteration on a single file should use
// `node --test tests/unit/<file>.test.mjs` directly (bypasses this runner).
